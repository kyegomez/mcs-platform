export async function runMedicalGroupChat(task: string, history: Array<{ role: string; content: string }>, selectedModel?: string) {
  try {
    ...
    console.error("Error running medical groupchat:", error)
    throw error
  }
} 